class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[10]", arg1_1: "f32[10]"):
        # File: /Users/unicorn/workspace/learn_pytorch2.0/dynamo/Frame_Evaluation.py:12, code: x = a / (torch.abs(a) + 1)
        ...
        # File: /Users/unicorn/workspace/learn_pytorch2.0/dynamo/Frame_Evaluation.py:13, code: if b.sum() < 0:
